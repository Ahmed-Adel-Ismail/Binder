...
class BinderFunctionStatements implements Function<BoundTypes, List<String>> {
    ...
    private String declareCompositeDisposable() {
        return CompositeDisposable.class.getName() + " " + BinderCodeGenerator.VARIABLE_NAME_DISPOSABLES;
    }

    private String initializeCompositeDisposable() {
        return BinderCodeGenerator.VARIABLE_NAME_DISPOSABLES + " = new " + CompositeDisposable.class.getName() + "()";
    }
    ...
    private String returnCompositeDisposables() {
        return "return " + BinderCodeGenerator.VARIABLE_NAME_DISPOSABLES;
    }
